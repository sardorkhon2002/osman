...
export default function Footer() {
  return (
    <footer id="contacts" className="w-full mt-24">
      <div className="bg-[#f6f6f6] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center md:flex-row md:items-start justify-between">
          <div className="flex flex-col items-center md:items-start p-8">
              ...
              <div className="flex flex-col md:flex-row gap-x-12 gap-y-3">
                {navigation.map((item) => (
                  <div
                    ...
                    className="text-md font-semibold leading-6 text-gray-900 cursor-pointer hover:text-[#38bdf8]"
                  >
                    {item.name}
                  </div>
                ))}
            ...
            <div className="flex items-center gap-2 mt-10">
              ...
              <span className="text-lg font-medium">+998 71 xxx xx xx</span>
            </div>
          </div>
          <div className="p-4 w-[400px] md:w-[600px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1500.2485596394727!2d69.21501310691654!3d41.23272813786275!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae61947afb5fb3%3A0x4eb5241eda3b95f1!2sSergeli%20Moshina%20Bozor!5e0!3m2!1sen!2s!4v1720353130939!5m2!1sen!2s"
              width="100%"
              height="300"
              title="map"
            ></iframe>
        ...
        {/*<div className="max-w-3xl mx-auto mt-4">
          ...
          <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-4">
            <li>
              <a
                href="#"
          ...
          <div className="flex space-x-10 justify-center items-center mb-6">
            <a
              href="#"
              className="block  text-gray-900 transition-all duration-500 hover:text-[#38bdf8] "
            >
              <svg
      ...
      <span className="text-s text-gray-500 text-center block py-2.5 border-t-[1px] border-[#808080]">
        ©<a href="#">OSMAN</a> {new Date().getFullYear()} All rights reserved.
      </span>
    </footer>
  );
}
